        ...
        <main className="p-8 space-y-8 animate-enter max-w-5xl mx-auto font-sans">
            <div className="flex justify-between items-end border-b-2 border-slate-900 pb-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1 font-medium">DRE Gerencial Consolidado (Regime de Caixa) - {mes}/{ano}</p>
                </div>
                <button className="flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-slate-900 transition-colors border border-slate-300 px-4 py-2 rounded-md shadow-sm">
